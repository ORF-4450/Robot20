...
/**
 * This is a FIRST class, dropped for 2020, that 4450 needs to use its "SampleRobot"
 * style of programming, so we took a copy and added it to our source code. Do not
 * modify this class unless you know what you are doing.
 */
 ...
 * yourself.
 *
 * Copied from 2019 Wpilibj and Modified by Team 4450 for 2020 season to allow SampleRobot based 
 * code to continue to be used.
 */
//@Deprecated
public class SampleRobot extends RobotBase {
  private boolean m_robotMainOverridden = true;
  private boolean m_endCompetition = false;
  ...
  public void startCompetition() 
  {
    ...
    {
      while (!Thread.currentThread().isInterrupted() && !m_endCompetition) 
      {
        if (isDisabled()) 
        {
